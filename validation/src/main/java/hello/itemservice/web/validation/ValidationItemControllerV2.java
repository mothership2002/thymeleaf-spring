...
//    @PostMapping("/add")
//    public String addItemV5(@ModelAttribute Item item, BindingResult br, RedirectAttributes redirectAttributes) {
//
...
//    }
    ...
    @PostMapping("/add")
    public String addItemV6(@Validated @ModelAttribute Item item, BindingResult br, RedirectAttributes redirectAttributes) {
